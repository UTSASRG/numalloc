...
#ifdef INTERHEAP_SUPPORT
  void stopInterHeapPhase() {
    _interheapPhase = false;
    _interheap.stopPhase();
  } 

  void startInterHeapPhase() {
    _interheapPhase = true;
...
#ifdef INTERHEAP_SUPPORT
    //if(_interheapPhase && (size > (PAGE_SIZE * NUMA_NODES/2))) {
    if(_interheapPhase) {
