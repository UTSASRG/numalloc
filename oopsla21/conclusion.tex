...
Based on our extensive evaluation, \NM{} achieves a significantly better performance than other popular allocators on the NUMA architecture, \toconfirm{with 14\% performance speedup on average and up to $1.86\times$ faster. }
