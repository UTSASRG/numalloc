...
\centering
\subfloat[glibc]{
   \includegraphics[width=5.5in]{HPCA2022/figure/binding-glibc.pdf}
}

\subfloat[TCMalloc]{
   \includegraphics[width=5.5in]{HPCA2022/figure/binding-tcmalloc.pdf}
}
\caption{Normalized runtime with and without node-balanced thread binding for Glibc and TCMalloc.}
\end{figure*}
