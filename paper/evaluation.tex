...
From Fig.~\ref{binding-pthread-scalibity}, we can see that it got some huge performance improvement from binding, especially that the performance difference of \texttt{fluidanimate} is around 0.8, and 0.2 for \texttt{streamcluster}.It clearly indicates that binding threads evenly over nodes could heavily reduce resource contention and bring significant improvement.
