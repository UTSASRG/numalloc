...
%we propose the combination of per-node heap and per-thread cache. \todo{In order to reduce the contention, \NM{} will obtain multiple objects at a time from the per-node heap. }
